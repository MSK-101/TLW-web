  ...
  return (
    <div className="flex lg:flex-row flex-col gap-16 xl:gap-24 mb-[124px] lg:px-14">
      <div className="xl:max-w-[600px] text-center lg:text-left mb-5">
        ...
        <h2 className="text-5xl">Een korte sneak peak naar de app features</h2>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
          <div className="rounded-3xl bg-[#F0F0F0] text-[#282828] p-[32px] self-end">
            ...
            <p className="text-sm mt-3">
              Weg met steeds al je apps openen. Krijg nu AL jouw crypto assets
              in één overzicht door jouw exchanges te koppelen en zie al jouw
              data: winst/verlies, Gem. Aankoopkoers en meer.
            </p>
          </div>
          <div className="rounded-3xl bg-[#F0F0F0] text-[#282828] p-[32px] self-end">
            <div className="flex items-center gap-3">
            ...
            <p className="text-sm mt-3">
              ...
              namelijk stap voor stap geholpen bij het maken van een duidelijk,
              haalbaar en concreet plan.
            </p>
          </div>
          <div className="rounded-3xl bg-[#F0F0F0] text-[#282828] p-[32px] self-start">
            ...
            <p className="text-sm mt-3">
              ...
              vaststelt én ook gaat behalen? Wat daarvoor investeer je toch.. om
              er iets uit te halen! Maak bij ons spaardoelen aan en bepaal met
              welke exchange en welke coins je deze wil gaan behalen! O ja, en
              je kunt het delen in de Partyzone als je het gehaald hebt (hoeft
              niet, mag wel).
            </p>
          </div>
