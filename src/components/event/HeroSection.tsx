...
export default function HeroSection() {
  ...
  return (
    <div className="bg-[url(/hero_image_event.jpg)] bg-top bg-cover bg-no-repeat rounded-[32px] mx-4 lg:mx-8 pt-[104px] px-[24px] pb-[32px] lg:py-36 lg:px-36">
      ...
      <div className="flex gap-2 lg:gap-6 mt-10">
        <Link href="https://wwwthelimitlesswaynl.plugandpay.com/checkout/event">
          <Button className="bg-[#E6C7FF] text-[#282828] py-5 px-3 md:px-6 flex-1 md:flex-none gap-[18px] cursor-pointer hover:scale-105">
        ...
        <Link href="#agenda">
          <Button
            variant="outline"
            className="bg-[#282828] text-gray-50 py-5 px-3 md:px-6 flex-1 md:flex-none gap-[18px] cursor-pointer hover:scale-105"
          >
      ...
      <div className="w-full xl:w-[80%] 2xl:w-[50%] mt-24">
