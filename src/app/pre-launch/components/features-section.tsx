        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
          <div className="rounded-3xl bg-[#F0F0F0] text-[#282828] p-[32px] self-end">
            ...
            <p className="text-sm mt-3">
              Mi velit tortor mi feugiat. Tincidunt vestibulum tortor habitasse
              tincidunt non. Purus varius sed massa risus ut pellentesque.
            </p>
          </div>
          <div className="rounded-3xl bg-[#F0F0F0] text-[#282828] p-[32px] self-end">
            <div className="flex items-center gap-3">
            ...
            <p className="text-sm mt-3">
              Purus varius sed massa risus ut pellentes. Turpis at donec ut urna
              netus malesuada blandit pellentesque.
            </p>
          </div>
          ...
          <div className="rounded-3xl bg-[#F0F0F0] text-[#282828] p-[32px] self-start">
            ...
            <p className="text-sm mt-3">
              ...
              pharetra convallis. Felis tortor feugiat et in congue nunc magna
              enim facilisis.
            </p>
          </div>
        </div>
